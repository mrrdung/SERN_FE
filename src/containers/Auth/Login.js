                    ...
                    <div className="login-content row">
                        ...
                        <div className="col-11 form-group login-input" >
                            ...
                            <input type='text' className='form-control ' placeholder='Enter your username'
                                ...
                                onChange={(event) => this.handleUserName(event)}></input>
                        </div>
                        <div className='col-11 form-group login-input'>
                            <label>Password</label>
                            <input type={this.state.isEyepassWord === false ? "password" : "text"} className='form-control' placeholder='Enter your Password'
                                value={this.state.password}
                                onChange={(event) => this.handlePassword(event)}></input>
                            <span className='eye-pass'
                                onClick={() => this.handleChangeEye()}
                            ><i className={this.state.isEyepassWord === false ? "fas fa-eye" : "fas fa-eye-slash"}></i></span>
